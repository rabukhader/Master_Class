...
class QuestionNumberCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      onTap: onTap,
      child: Ink(
        child: Center(child: Text('$index', style: TextStyle(color: status ==AnswerStatus.notanswered?Theme.of(context).primaryColor:null),
        )
        ), 
        padding: const EdgeInsets.all(10),
        decoration: BoxDecoration(color: _backgroundColor, borderRadius: UIParameters.cardBorderRadius )
      ,)
    );
  }
}